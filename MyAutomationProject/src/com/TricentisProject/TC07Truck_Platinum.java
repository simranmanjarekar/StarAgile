...
//	    driver.findElement(By.id("genderfemale")).click();
	   ...
	   // js.executeScript("arguments[0].click();",driver.findElement(By.id("EuroProtection")));
	    ...
	    //Send Quote
	    String expPrice="1,525.00",expClaim="Submit",expDisc="5",expCover="Limited",actPrice,actClaim,actDisc,actCover;
	    ...
	    System.out.println("Checking truck-platinum values");
