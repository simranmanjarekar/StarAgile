...
//	    driver.findElement(By.id("genderfemale")).click();
	   ...
	   // js.executeScript("arguments[0].click();",driver.findElement(By.id("EuroProtection")));
	    ...
	    //Select Price option
	    String expPrice="2,905.00",expClaim="Submit",expDisc="10",expCover="Unlimited",actPrice,actClaim,actDisc,actCover;
	    ...
	    System.out.println("Checking truck-ultimate values");
