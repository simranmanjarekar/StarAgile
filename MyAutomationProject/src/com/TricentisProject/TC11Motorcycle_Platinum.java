...
//	    driver.findElement(By.id("genderfemale")).click();
	   ...
	   // js.executeScript("arguments[0].click();",driver.findElement(By.id("EuroProtection")));
	    ...
	    //Select Price option
	    String expPrice="1,302.00",expClaim="Submit",expDisc="5",expCover="Limited",actPrice,actClaim,actDisc,actCover;
	    actPrice=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[1]/td[4]/span")).getText();
	    actClaim=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[2]/td[4]")).getText();
	    actDisc=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[3]/td[4]")).getText();
	    actCover=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[4]/td[4]")).getText();
	  
	    System.out.println("Checking motorcycle-platinum values");
	    ...
	    js.executeScript("document.getElementById('selectplatinum').click();");
