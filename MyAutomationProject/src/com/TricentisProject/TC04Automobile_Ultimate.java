...
//		    driver.findElement(By.id("genderfemale")).click();
		    ...
		    //Enter product data
		    driver.findElement(By.id("startdate")).sendKeys("03/11/2025");
		   ...
		   // js.executeScript("arguments[0].click();",driver.findElement(By.id("EuroProtection")));
		    ...
		    //Select Price option
		    String expPrice="2,453.00",expClaim="Submit",expDisc="10",expCover="Unlimited",actPrice,actClaim,actDisc,actCover;
		    actPrice=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[1]/td[5]/span")).getText();
		    actClaim=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[2]/td[5]")).getText();
		    actDisc=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[3]/td[5]")).getText();
		    actCover=driver.findElement(By.xpath("//section[@id=\"pricePlans\"]/div/table/tbody/tr[4]/td[5]")).getText();
		  
		    System.out.println("Checking automobile-ultimate values");
		    ...
		    js.executeScript("document.getElementById('selectultimate').click();");
