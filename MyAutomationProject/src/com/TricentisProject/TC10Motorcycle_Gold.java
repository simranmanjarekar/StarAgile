...
//	    driver.findElement(By.id("genderfemale")).click();
	   ...
	   // js.executeScript("arguments[0].click();",driver.findElement(By.id("EuroProtection")));
	    ...
	    //Select Price option
	    String expPrice="663.00",expClaim="Submit",expDisc="2",expCover="Limited",actPrice,actClaim,actDisc,actCover;
	    ...
	    System.out.println("Checking motorcycle-gold values");
